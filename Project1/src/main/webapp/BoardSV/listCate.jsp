...
<%
	...
	int totalCount = dao.selectCategory(map);
	...
	map.put("start", start);
	map.put("end", end); // Map 을 통해 검색 조건과 같은 타입으로 전달
	
	List<ShowDTO> dto = dao.lists(map);
	dao.close();
%>   
<!DOCTYPE html>
<html lang="kr">
   ...
   %>                 
                    <div class="col mb-5">                      
                        <div class="card h-100">
                            <!-- Product image-->
                            <img class="card-img-top" src="resources/image/<%=list.getMain_jpg() %>.jpg" alt="<%=list.getTitle() %>" />
                            <!-- Product details-->
                            <div class="card-body p-4">
                                <div class="text-center">
                                    <!-- Product name-->
                                    <h6 class="fw-bolder"><%=list.getTitle() %></h6>
                                    ...
                                    <%
										if(list.getPlatform().contains("Netflix")){
									%>                     
									...
									<!-- 넷플릭스 아이콘 -->
									<% } if(list.getPlatform().contains("Tving")) { %>
                                	...
                                	<!-- 티빙아이콘 -->
                                	<% } if(list.getPlatform().contains("Disney+")){ %>
                                	<svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="30" height="30" viewBox="0 0 48 48">
                            ...
                            <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                                <div class="text-center" ><a class="btn btn-outline-dark mt-auto" href="view.jsp?title=<%=list.getTitle()%>">상세보기</a></div>
                            </div>
                        </div>                  
                    </div>   
    <%
